...
df = pd.read_csv("./datasets/ai_vs_human/AI_Human.csv")
#print(df)
...
np.save('./datasets/ai_vs_human/X_test_avh.npy', X_test)
np.save('./datasets/ai_vs_human/y_test_avh.npy', y_test)
...
model.save('./datasets/ai_vs_human/avh.keras')